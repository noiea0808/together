...
const styles = {
  ...
  label: { fontSize: 'var(--font-size-xs)', fontWeight: 600, color: 'var(--color-text-muted)', marginBottom: 6 },
  row: {
  ...
  codeText: { fontSize: 20, fontWeight: 700, letterSpacing: 3, color: 'var(--color-text)' },
  ...
  copyBtn: {
    ...
    color: '#fff', fontSize: 'var(--font-size-xs)', fontWeight: 600, cursor: 'pointer',
  },
