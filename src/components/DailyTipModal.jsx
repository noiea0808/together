...
const styles = {
  ...
  dialog: {
    ...
    borderRadius: 'var(--radius-lg)', padding: '20px var(--spacing-lg)',
    display: 'flex', flexDirection: 'column', gap: 'var(--spacing-md)',
  },
  header: { display: 'flex', alignItems: 'center', justifyContent: 'space-between' },
  headerTitle: { fontWeight: 800, fontSize: 'var(--font-size-lg)' },
  tabRow: { display: 'flex', gap: 6, background: 'var(--color-surface-2)', borderRadius: 'var(--radius-full)', padding: 4 },
  tabBtn: {
  ...
  image: { width: '100%', height: 'auto', maxHeight: '60vh', objectFit: 'cover', display: 'block', borderRadius: 'var(--radius-md)' },
  body: { fontSize: 'var(--font-size-sm)', color: 'var(--color-text)', textAlign: 'center', whiteSpace: 'pre-line', lineHeight: 1.6, margin: 0 },
