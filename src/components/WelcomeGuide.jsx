...
const styles = {
  ...
  title: { fontFamily: 'var(--font-title)', fontSize: 28, fontWeight: 700, color: 'var(--color-text)', lineHeight: 1.3, letterSpacing: '-0.5px', margin: '0 0 14px', whiteSpace: 'pre-line' },
