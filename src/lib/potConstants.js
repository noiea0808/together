...
// 밥팟 최대 인원 상한 — 만들기/수정/그룹 기본팟 설정 화면이 각자 다른 숫자(8, 10)를 쓰고 있어서
// "만들 때는 8명이 최대였는데 나중에 수정하면 10명까지 된다"는 불일치가 있었다. 한 곳에서 관리한다.
export const MIN_POT_PEOPLE = 2
export const MAX_POT_PEOPLE = 10
