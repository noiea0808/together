...
const S = {
  ...
  dateHeader: { fontSize: 'var(--font-size-xs)', fontWeight: 600, color: 'var(--color-text-muted)', padding: '6px 2px' },
  ...
  groupLabel: { fontSize: 'var(--font-size-2xs)', fontWeight: 600, color: 'var(--color-chip-text)', flexShrink: 0 },
  potTitle: { fontSize: 'var(--font-size-xs)', fontWeight: 600, color: 'var(--color-text-muted)', letterSpacing: '-0.3px', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' },
  scopeChip: {
    position: 'absolute', top: 12, right: 12, flexShrink: 0, padding: '2px 7px', borderRadius: 'var(--radius-full)',
    background: 'var(--color-surface)', border: '1px solid var(--color-border)',
    fontSize: 'var(--font-size-2xs)', fontWeight: 600, color: 'var(--color-text-muted)',
  },
  potMeta: { display: 'flex', flexDirection: 'column', gap: 1, marginTop: 3 },
  menuText: { fontSize: 'var(--font-size-sm)', fontWeight: 700, color: 'var(--color-text)', letterSpacing: '-0.3px' },
  metaSub: { fontSize: 'var(--font-size-2xs)', color: 'var(--color-text-muted)', fontWeight: 600 },
  commentBadge: { fontSize: 'var(--font-size-2xs)', fontWeight: 600, color: 'var(--color-text-muted)' },
  ...
  avatarDot: {
    ...
    background: 'var(--warm-500)', color: '#fff', fontSize: 10, fontWeight: 700,
  ...
  avatarOverflow: { marginLeft: 2, fontSize: 'var(--font-size-2xs)', fontWeight: 600, color: 'var(--color-text-muted)' },
