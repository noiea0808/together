...
const s = {
  ...
  bulkDeleteBtn: { flexShrink: 0, border: '1.5px solid #E04545', background: '#fff', color: '#E04545', borderRadius: 8, padding: '9px 16px', fontSize: 13, fontWeight: 600, cursor: 'pointer' },
  ...
  badgeDone: { fontSize: 11, fontWeight: 600, color: '#34A853', background: '#EAF7EE', padding: '2px 8px', borderRadius: 4 },
  badgePending: { fontSize: 11, fontWeight: 600, color: '#E65100', background: '#FFF3E0', padding: '2px 8px', borderRadius: 4 },
  badgeGuest: { fontSize: 11, fontWeight: 600, color: '#7070A0', background: '#F0F0F8', padding: '2px 8px', borderRadius: 4 },
  badgeMale: { fontSize: 11, fontWeight: 600, color: '#1565C0', background: '#E3F2FD', padding: '2px 8px', borderRadius: 4 },
  badgeFemale: { fontSize: 11, fontWeight: 600, color: '#C2185B', background: '#FCE4EC', padding: '2px 8px', borderRadius: 4 },
