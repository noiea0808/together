...
const s = {
  ...
  addBtn: { flexShrink: 0, background: '#FF6B35', color: '#fff', border: 'none', borderRadius: 8, padding: '10px 16px', fontSize: 13, fontWeight: 600, cursor: 'pointer' },
  ...
  badgeReq: { fontSize: 11, fontWeight: 600, color: '#FF6B35', background: '#FFF0EA', padding: '2px 8px', borderRadius: 4 },
  badgeOpt: { fontSize: 11, fontWeight: 600, color: '#7070A0', background: '#F0F0F8', padding: '2px 8px', borderRadius: 4 },
