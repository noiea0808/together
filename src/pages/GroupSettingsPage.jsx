...
const styles = {
  ...
  configTitle: { fontWeight: 700, fontSize: 'var(--font-size-sm)', marginBottom: 2 },
  ...
  configSlot: { fontSize: 'var(--font-size-sm)', fontWeight: 700, background: '#E8F5E9', color: '#4CAF50', borderRadius: 4, padding: '1px 6px' },
  configTime: { fontSize: 'var(--font-size-sm)', color: 'var(--color-primary)', fontWeight: 600 },
  configName: { fontSize: 'var(--font-size-sm)', fontWeight: 600 },
  configModifier: { fontSize: 'var(--font-size-xs)', color: '#9E9E9E' },
  editConfigBtn: { padding: '4px 10px', background: 'none', color: 'var(--color-primary)', border: '1px solid var(--color-primary)40', borderRadius: 'var(--radius-full)', fontSize: 'var(--font-size-sm)', cursor: 'pointer', flexShrink: 0 },
