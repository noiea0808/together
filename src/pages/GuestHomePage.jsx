...
const styles = {
  ...
  guestTag: { fontSize: 11, fontWeight: 800, color: '#fff', background: '#FF9800', borderRadius: 'var(--radius-full)', padding: '2px 10px' },
  ...
  slotName: { fontSize: 12, fontWeight: 700, color: 'var(--color-text-muted)', textAlign: 'center', padding: '10px 4px 9px', background: 'rgba(0,0,0,0.02)', borderBottom: '1px solid rgba(0,0,0,0.05)' },
