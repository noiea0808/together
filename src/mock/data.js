...
export const SLOT_STATUS_OPTIONS = [
  ...
  { key: '참여중', label: '같이 먹을 예정', emoji: '🍚', color: '#FF6B35', bg: '#FFF4EF', border: '#FFD6C0', selectable: false },
  { key: '참여완료', label: '참여완료', emoji: '🍚', color: '#FF6B35', bg: '#FFF4EF', border: '#FFD6C0', selectable: false },
]
